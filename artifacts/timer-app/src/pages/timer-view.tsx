...
export default function TimerView() {
  ...
  return (
    <div className="min-h-screen w-full bg-black flex items-center justify-center overflow-hidden relative selection:bg-transparent cursor-default">
      ...
      <Link 
        href={`/sala/${id}/admin`} 
        className="absolute bottom-4 right-4 text-white/5 hover:text-white/30 text-[10px] font-mono tracking-widest transition-colors uppercase py-2 px-4 rounded hover:bg-white/5"
      >
        Painel de Controle
      </Link>
    </div>
